...
const HEADER_ALIASES: Record<keyof Omit<OportunidadComercial, "rowId">, string[]> = {
  ...
  idExterno:             ["id externo", "external id", "id"],
  creado:                ["creado", "fecha creacion", "fecha creación", "created on", "create date"],
  ...
  identificacionProceso: ["identificacion proceso", "identificacion del proceso", "proceso", "process id"],
  canalRecepcion:        ["canal recepcion", "canal recepción", "canal de recepcion", "channel"],
  sector:                ["sector"],
  subsector:             ["subsector", "sub sector", "sub-sector"],
  modalidad:             ["modalidad", "modality"],
  aliado:                ["aliado", "partner", "socio"],
  razonSocialAliado:     ["razon social aliado", "razon social del aliado"],
  fabricante:            ["fabricante", "manufacturer", "marca"],
  actualizado:           ["actualizado", "ultima actualizacion", "last update"],
  cliente:               ["cliente", "customer", "account"],
  oportunidad:           ["nombre oportunidad", "oportunidad", "opportunity name", "nombre de la oportunidad"],
  linea:                 ["linea de negocio", "linea", "línea de negocio", "línea", "business line"],
  consultoriaCOP:        ["consultoria cop", "consultoría cop"],
  datosCOP:              ["datos cop"],
  tiCOP:                 ["ti cop", "tecnologia cop"],
  ingresoEsperado:       ["ingreso esperado", "valor esperado", "importe esperado", "expected revenue"],
  tipoVenta:             ["tipo de venta", "tipo venta", "sale type"],
  segmento:              ["segmento", "segment"],
  tipoOportunidad:       ["tipo de oportunidad", "tipo oportunidad", "opportunity type"],
  objeto:                ["objeto", "descripcion", "descripción", "description"],
  clienteFinal:          ["cliente final", "end customer", "usuario final"],
  ganado:                ["ganado", "resultado", "won", "result"],
  razonPerdida:          ["razon de perdida", "razon perdida", "razón de pérdida", "lost reason"],
  etapaActual:           ["etapa actual", "stage name"],
  motivoDeclinacion:     ["motivo de declinacion", "motivo declinacion", "decline reason"],
