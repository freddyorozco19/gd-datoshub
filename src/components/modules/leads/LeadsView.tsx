    ...
    <div className="flex flex-col h-full overflow-hidden">
      ...
      <div className="flex-1 overflow-auto p-5 space-y-4 relative">
        ...
        <div className="fixed inset-0 -z-10 overflow-hidden pointer-events-none">
          <div className="absolute -top-10 right-[5%] w-[480px] h-[420px] bg-rose-500/25 blur-[120px]"
          ...
          <div className="absolute top-[2%] left-[8%] w-[340px] h-[380px] bg-fuchsia-500/15 blur-[120px]"
